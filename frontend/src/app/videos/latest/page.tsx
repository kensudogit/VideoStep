...
export default function LatestVideosPage() {
  ...
  const fetchLatestVideos = async () => {
    try {
      ...
      const data = await apiRequest<Video[]>(`/api/videos/recommendations/latest?limit=50`)
      
      console.log('Fetched latest videos data:', data)
          ...
          <>
            {videos.length > 0 ? (
              ...
              <div className="text-center py-20">
                ...
                <p className="text-gray-600 dark:text-gray-400">最新動画がまだありません</p>
              </div>
            )}
          </>
        )}
