package com.videostep.translation.config;
                        ...
                        if (atIndex > 0) {
                            ...
                            if (colonIndex > 0) {
                                ...
                                if (username.equals("videostep")) {
                                    System.out.println(
                                            "DatabaseConfig: WARNING - 'videostep' user detected in DATABASE_URL. Railway PostgreSQL uses 'postgres' user by default.");
                                    ...
                                    if (pgUser != null && !pgUser.isEmpty() && !pgUser.equals("videostep")) {
                                        ...
                                        System.out.println(
                                                "DatabaseConfig: PGUSER not set, trying 'postgres' as default Railway user");
                                        username = "postgres";
                                    }
                                }
                                ...
                                if (password.equals("videostep")) {
                                    ...
                                    if (pgPassword != null && !pgPassword.isEmpty()
                                        ...
                                        throw new IllegalStateException(
                                                "Invalid database credentials: 'videostep' password cannot be used with '"
                                                        + username + "' user. " +
